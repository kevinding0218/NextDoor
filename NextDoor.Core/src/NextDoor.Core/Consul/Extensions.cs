...
namespace NextDoor.Core.Consul
{
    public static class Extensions
    {
        public static IServiceCollection AddConsul(this IServiceCollection services)
        {
            ...
            var options = configuration.GetOptions<ConsulOptions>(ConfigOptions.consulSectionName);
            services.Configure<ConsulOptions>(configuration.GetSection(ConfigOptions.consulSectionName));
            services.Configure<FabioOptions>(configuration.GetSection(ConfigOptions.fabioSectionName));
        ...
        public static string UseConsul(this IApplicationBuilder app)
        {
            using (var scope = app.ApplicationServices.CreateScope())
            {
                ...
                if (consulOptions.Value.PingEnabled || fabioOptions.Value.Enabled)
                {
                    ...
                    // Every "pingInterval" seconds, ping my uri under specific url
                    // If my endpoint doesn't respond, meaning something wrong gwith my app and I should remove it.
