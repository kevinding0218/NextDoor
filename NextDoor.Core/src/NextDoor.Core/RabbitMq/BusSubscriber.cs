        ...
        */
        private string GetQueueName<TCommand>(string @namespace = null, string name = null)
        {
            ...
            return (string.IsNullOrWhiteSpace(name)
                ? $"{Assembly.GetEntryAssembly().GetName().Name}/{separatedNamespace}{typeof(TCommand).Name.Underscore()}"
                : $"{name}/{separatedNamespace}{typeof(TCommand).Name.Underscore()}").ToLowerInvariant();
        }
