...
namespace NextDoor.Core.Handlers
{
    public class Handler : IHandler
    {
        ...
        private Func<NextDoorException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<NextDoorException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (NextDoorException customException)
            {
                isFailure = true;
